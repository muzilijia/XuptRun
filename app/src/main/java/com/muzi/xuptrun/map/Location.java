...
public class Location implements LocationSource, AMapLocationListener, SensorEventListener {
    ...
    public void deactivate() {
        ...
        Toast.makeText(mContext, "结束运动", Toast.LENGTH_SHORT).show();
    }
    ...
    public void startLocation() {
        ...
        if (!isRunning) {
            ...
            if (isFirstLatLng) {
                record = new PathRecord();
                Toast.makeText(mContext, "开启新的一次跑步", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(mContext, "运动已恢复", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void pauseLocation() {
        if (mlocationClient.isStarted()) {
            ...
            mlocationClient.stopLocation();
            Toast.makeText(mContext, "运动已暂停", Toast.LENGTH_SHORT).show();
        }
    }
